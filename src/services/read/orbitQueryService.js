...
// async function tryRebuildOrFallback(currentSnapshot, rebuildFn, label, meta = {}) {
//   try {
//     return await rebuildFn();
//   } catch (error) {
//     console.error(`[${label}_REBUILD_FAILED]`, meta, error);
...
//       if (isMissing) {
//         snapshot = await tryRebuildOrFallback(
//           snapshot,
//           () => rebuildAndEnrichLevelSnapshot(normalizedAddress, level),
//           'LEVEL_SNAPSHOT',
//           { address: normalizedAddress, level, reason: 'missing' }
//         );
//       } else {
//         if (isIncomplete || hasNewIndexedActivity || isStale) {
//           refreshLevelSnapshotInBackground(normalizedAddress, level);
...
//         snapshot = await tryRebuildOrFallback(
//           snapshot,
//           () => rebuildPositionSnapshot(normalizedAddress, level, position),
//           'POSITION_SNAPSHOT',
//           { address: normalizedAddress, level, position, reason: 'missing' }
//         );
//       } else {
//         if (isIncomplete || hasNewIndexedActivity || isStale) {
//           refreshPositionSnapshotInBackground(
...
//         snapshot = await tryRebuildOrFallback(
//           snapshot,
//           () => rebuildCycleSnapshot(normalizedAddress, level, cycleNumber),
//           'CYCLE_SNAPSHOT',
//           { address: normalizedAddress, level, cycleNumber, reason: 'missing' }
//         );
//       } else {
//         if (isIncomplete || hasNewIndexedActivity || isStale) {
//           refreshCycleSnapshotInBackground(
