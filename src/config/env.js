...
const env = {
  ...
  NFT_POOL_ADDRESS: optional('NFT_POOL_ADDRESS'),
  OPERATIONS_WALLET_ADDRESS: optional('OPERATIONS_WALLET_ADDRESS'),
  NFT_POOL_VAULT_ADDRESS: optional('NFT_POOL_VAULT_ADDRESS'),
  OPERATIONS_VAULT_ADDRESS: optional('OPERATIONS_VAULT_ADDRESS'),
